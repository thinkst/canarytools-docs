...
```json
{
  "audit_trail": [
    ...
    },
    {
      ...
      "id": 70,
      "message": "User 'API Token' scheduled the device 00000000da79c492 to be rebooted",
...
```json
{
  "audit_trail": [
    ...
    },
    {
      ...
      "flock_id": "flock:default",
      "id": 66,
      "message": "Moved 00000000da79c492 to flock:default",
    ...
    },
    {
      ...
      "additional_information": null,
      "flock_id": "flock:a8d4e3c94ec1b1c265f4441ed3c57169",
      "id": 65,
      "message": "User '<user_email>' pushed settings to device 00000000da79c492",
